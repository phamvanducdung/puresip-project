...
export default function Cart() {
    ...
    // Xóa toàn bộ số lượng sản phẩm đã chọn.
    ...
    // Tổng giá trị đơn hàng sẽ bằng tổng số tiền cần thanh toán.
    ...
    return (
        <main>
            <div className="container grid grid-cols-3 gap-6 py-10 mx-auto">
                <div className="grid col-span-2 p-6 bg-white  border-2 shadow-md">
                ...
                <div className="grid col-span-1 p-6 bg-white shadow-md  border-2">
